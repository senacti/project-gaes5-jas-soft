 ...
 <div class="modal" id="editar{{$insumo->id}}">
            ...
            <form action="{{ route('insumo.actualizar')}}" class="was-validated" method="POST">  
              ...
              <div class="row">
                <div class="form-floating mb-3 mt-3">
                  <input type="text" class="form-control" id="NombreInsumo" placeholder="Nombre Insumo" name="NombreInsumo" required value="{{$insumo->NombreInsumo}}"> 
                ...
                <div class="form-floating mt-3 mb-3 col-4">
                  <select class="form-select" id="Unidadmedida" name="Unidadmedida" required value="{{$insumo->Unidadmedida}}">
   ...
   <!-- The Modal -->
 <div class="modal" id="delete{{$insumo->id}}">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
          ...
          <form action="{{ route('insumo.destroy',$insumo->id)}}" class="was-validated" method="POST">  
            @csrf                          
            @method ('DELETE')
            <div class="modal-body">
            <div class="row">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="document.getElementById('submitInsumo').click();return false;" class="btn btn-primary">{{ __('Confirmar') }}</button>
