    ...
    <div class="modal-dialog">
      <div class="modal-content">
            ...
            <form action="{{ route('registerInsumo.almacenar')}}" class="was-validated" method="POST">  
              ...
              <div class="row">
                <div class="form-floating mb-3 mt-3">
                  <input type="text" class="form-control" id="Nombre Insumo" placeholder="Nombre Insumo" name="NombreInsumo" required value="{{$insumo->NombreInsumo}}"> 
        ...
        <div class="modal-footer">
          ...
          <button type="button" onclick="document.getElementById('submitInsumo').click();return false;" class="btn btn-primary">{{ __('guardar') }}</button>          
        </div>
      </div>
    </div>
  </div>   
