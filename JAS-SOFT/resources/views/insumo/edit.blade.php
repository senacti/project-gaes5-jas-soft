    ...
    <div class="modal-body">
      <div class="row">
        <div class="form-floating mb-3 mt-3">
          <input type="hidden" class="form-control" id="idinsumo" placeholder="Nombre Insumo" name="idinsumo" required value="{{$insumos->IdInsumo}}">       
        </div>
        <div class="form-floating mt-3 mb-3 col-8">
          <input type="text" required class="form-control" id="Cantidad" placeholder="Cantidad" name="Cantidad" maxlength="9" value="{{$insumos->Cantidad}}">         
        ...
        <div class="form-floating mt-3 mb-3 col-6">
          <input type="text" class="form-control" id="Color" placeholder="Color" name="Color" required value="{{$insumos->Color}}">
