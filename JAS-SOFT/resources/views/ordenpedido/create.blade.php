        ...
        <div class="modal-content">
                ...
                <form action="validationForm" class="needs-validation" name="validationForm">
                    <div class="row">
                        <div class="form-floating mb-3 mt-3">
                            <input type="text" class="form-control" id="nombre" placeholder="Nombre Insumo"
                                name="Nombre Insumo" maxlength="30" required onkeypress="return soloLetras(event)">
                        ...
                        <div class="form-floating mt-3 mb-3 col-6">
                            <input type="text" required class="form-control" id="Cantidad"
                                placeholder="Cantidad del insumo" name="Cantidadinsumo" maxlength="#"
                                onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" data-bs-dismiss="modal"
                    onclick="verificar()">Guardar</button>
            </div>
        </div>
    </div>
</div>
